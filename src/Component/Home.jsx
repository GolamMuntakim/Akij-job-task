...
const Home = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-2 p-0 m-0 w-full  mx-auto">
        <Helmet>
          <title>
            Home
          </title>
        </Helmet>
      <div className="mt-10 w-full lg:w-[240px] min-h-screen shadow-xl ">
      ...
      <div className=" w-full lg:w-[1000px] -ml-24  lg:-ml-[390px] min-h-screen">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-28 gap-4 lg:gap-4 lg:p-8">
          {
            filteredProducts.map(product => (

              <div className="card w-60 ml-6 lg:w-full bg-base-100  shadow-sm shadow-black" key={product?._id}>
                <figure>
                  <img
        ...
        {/* pagination */}
        <div className='flex justify-center w-full mx-auto md:w-[400px] lg:w-[1000px] mt-12'>
          <button
