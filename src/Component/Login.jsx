...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-2 w-full  items-center gap-48 justify-center mt-20 lg:mt-0">
      <Helmet>
        <title>
          Login
        </title>
      </Helmet>
      <div className="ml-10 lg:ml-[200px] h-screen w-[350px]  mx-auto lg:w-[450px] ">
        <form className="card-body" onSubmit={handleSignIn}>
          ...
          <div className="form-control">
            ...
            <span className="absolute top-[300px] left-[290px] lg:left-[570px] lg:top-[190px]" onClick={() => setShowPassword(!showPassword)}
            >
              {
