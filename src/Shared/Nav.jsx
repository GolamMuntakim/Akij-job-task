...
const handleToggle = e => {
  ...
  <div className="navbar-start">
    ...
    <a className="lobster-regular text-xl flex items-center gap-2"><img src="images/logo.JPG" className='h-10 hidden lg:flex'/><div className='font-bold'>Furni<span className='text-[#1f99f4]'>Flex</span></div></a>
  </div>
